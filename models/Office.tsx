...
export default function Model(props) {
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <group
        onClick={() => {
          router.push('https://buncombe.tech/badvibes')
        }}
      ...
      />
      <group
        position={[6.09, 8.25, -2.36]}
        rotation={[Math.PI / 2, 0, -1.57]}
        scale={[-0.98, 0.67, 1.36]}
      >
        <mesh
          castShadow
          receiveShadow
      ...
      <group
        onClick={() => {
          router.push('https://buncombe.tech/Chart')
        }}
        position={[5.98, 8.45, 3.16]}
      ...
      />
      <group
        position={[0.51, 6.18, -6.26]}
        rotation={[-0.11, 1.56, -1.47]}
        scale={[-0.97, 0.33, -4.91]}
      >
        <mesh
          castShadow
          receiveShadow
